...
shinyUI(fluidPage(
  ...
  sidebarLayout(
    ...
    mainPanel(
      ...
      fluidRow(
        column(5, div(h4(p("Sequence")), style="font-family:'chalkduster';color:darkblue")),
        column(5, div(h4(p("Formula")), style="font-family:'chalkduster';color:darkblue")),
        column(2, div(h4(p("Res.#")), style="font-family:'chalkduster';color:darkblue"))
        ),
      fluidRow(
      ...
      column(8,DT::dataTableOutput("tb2"))
         ...
         tabPanel(h5("Isotopic distribution"),
               div(h4(p("Formula with PTMs")), style="font-family:'chalkduster';color:darkblue"),
               fluidRow(
                 column(6, verbatimTextOutput("text4"))
                 ),
               hr(),
              fluidRow(
              column(6, div(h4(p(strong("Charge State to Simulate: "))), style="font-family:'chalkduster';color:darkblue")),
         ...
         tabPanel(h5(strong(em("in silico")), "Digestion"),
                  br(),
                  fluidRow(
                    column(3, textInput("cleavSite", label=div("Cleavage Sites", style="font-family:'chalkduster';color:darkblue"), placeholder = "e.g., RK")),
                    column(2, textInput("side", label=div("Side", style="font-family:'chalkduster';color:darkblue"), placeholder = "C or N")),
                    column(2, numericInput("mc", label = div("Missed", style="font-family:'chalkduster';color:darkblue"), value=1,min=0, step=1, width = "80%")),
                    column(3, numericInput("thresh", label=div("Threshold", style="font-family:'chalkduster';color:darkblue"), value=4,min=0, step=1,width = "50%"))
                  ),
         ...
         tabPanel(h5("Targeted m/z"),
                  br(),
                  fluidRow(
                    column(3, div(strong("Charge from"), style="font-family:'chalkduster';color:darkblue; font-size:12pt", align="center")),
                    column(2, numericInput("csfrom", label=NULL,value=1, min=1, step=1, width = "80%")),
                    column(1, div(strong("to"), style="font-family:'chalkduster';color:darkblue; font-size:12pt")),
                    column(2, numericInput("csto", label=NULL, value=5, min=2, step=1, width="80%")),
                    column(4, checkboxGroupInput("target.ptm", label = div("PTMs to include",style="font-family:'chalkduster';color:darkblue; font-size:12pt"), choices=list("none","Oxidation","diOxidation","triOxidation","Carbonyl","Deamidation(N)","Phosphorylation(S,T,Y)"),selected="none"))
                  ),
                  fluidRow(
